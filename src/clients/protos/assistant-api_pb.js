...
goog.exportSymbol('proto.assistant_api.FileUploadConfig', null, global);
...
goog.exportSymbol('proto.assistant_api.GetAllAssistantSessionRequest', null, global);
goog.exportSymbol('proto.assistant_api.GetAllAssistantSessionResponse', null, global);
...
goog.exportSymbol('proto.assistant_api.PersonalizeAssistantRequest', null, global);
goog.exportSymbol('proto.assistant_api.SpeechToTextConfig', null, global);
goog.exportSymbol('proto.assistant_api.TextToSpeechConfig', null, global);
 ...
 * @constructor
 */
proto.assistant_api.TextToSpeechConfig = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.assistant_api.TextToSpeechConfig.repeatedFields_, null);
};
goog.inherits(proto.assistant_api.TextToSpeechConfig, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.assistant_api.TextToSpeechConfig.displayName = 'proto.assistant_api.TextToSpeechConfig';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.assistant_api.SpeechToTextConfig = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.assistant_api.SpeechToTextConfig.repeatedFields_, null);
};
goog.inherits(proto.assistant_api.SpeechToTextConfig, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.assistant_api.SpeechToTextConfig.displayName = 'proto.assistant_api.SpeechToTextConfig';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.assistant_api.FileUploadConfig = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.assistant_api.FileUploadConfig.repeatedFields_, null);
};
goog.inherits(proto.assistant_api.FileUploadConfig, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.assistant_api.FileUploadConfig.displayName = 'proto.assistant_api.FileUploadConfig';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.assistant_api.PersonalizeAssistantRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.assistant_api.PersonalizeAssistantRequest.repeatedFields_, null);
};
goog.inherits(proto.assistant_api.PersonalizeAssistantRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.assistant_api.PersonalizeAssistantRequest.displayName = 'proto.assistant_api.PersonalizeAssistantRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.assistant_api.GetAllAssistantSessionRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.assistant_api.GetAllAssistantSessionRequest.repeatedFields_, null);
};
goog.inherits(proto.assistant_api.GetAllAssistantSessionRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.assistant_api.GetAllAssistantSessionRequest.displayName = 'proto.assistant_api.GetAllAssistantSessionRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.assistant_api.GetAllAssistantSessionResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.assistant_api.GetAllAssistantSessionResponse.repeatedFields_, null);
};
goog.inherits(proto.assistant_api.GetAllAssistantSessionResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.assistant_api.GetAllAssistantSessionResponse.displayName = 'proto.assistant_api.GetAllAssistantSessionResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.assistant_api.TextToSpeechConfig.repeatedFields_ = [10];
 ...
 * @return {!Object}
 */
proto.assistant_api.TextToSpeechConfig.prototype.toObject = function(opt_includeInstance) {
  return proto.assistant_api.TextToSpeechConfig.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.assistant_api.TextToSpeechConfig} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.assistant_api.TextToSpeechConfig.toObject = function(includeInstance, msg) {
  var f, obj = {
    providerid: jspb.Message.getFieldWithDefault(msg, 1, "0"),
    providermodelid: jspb.Message.getFieldWithDefault(msg, 2, "0"),
    additionalparametersList: jspb.Message.toObjectList(msg.getAdditionalparametersList(),
    common_pb.ProviderModelParameter.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.assistant_api.TextToSpeechConfig}
 */
proto.assistant_api.TextToSpeechConfig.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.assistant_api.TextToSpeechConfig;
  return proto.assistant_api.TextToSpeechConfig.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.assistant_api.TextToSpeechConfig} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.assistant_api.TextToSpeechConfig}
 */
proto.assistant_api.TextToSpeechConfig.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 10:
      var value = new common_pb.ProviderModelParameter;
      reader.readMessage(value,common_pb.ProviderModelParameter.deserializeBinaryFromReader);
      msg.addAdditionalparameters(value);
      break;
    default:
      reader.skipField();
      break;
 ...
 * @return {!Uint8Array}
 */
proto.assistant_api.TextToSpeechConfig.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.assistant_api.TextToSpeechConfig.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.assistant_api.TextToSpeechConfig} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.assistant_api.TextToSpeechConfig.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getProviderid();
  if (parseInt(f, 10) !== 0) {
    writer.writeUint64String(
  ...
  f = message.getAdditionalparametersList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      10,
      f,
 ...
 * @return {string}
 */
proto.assistant_api.TextToSpeechConfig.prototype.getProviderid = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, "0"));
};
...
/**
 * @param {string} value
 * @return {!proto.assistant_api.TextToSpeechConfig} returns this
 */
proto.assistant_api.TextToSpeechConfig.prototype.setProviderid = function(value) {
  return jspb.Message.setProto3StringIntField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.assistant_api.TextToSpeechConfig.prototype.getProvidermodelid = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, "0"));
};
 ...
 * @return {!proto.assistant_api.TextToSpeechConfig} returns this
 */
proto.assistant_api.TextToSpeechConfig.prototype.setProvidermodelid = function(value) {
  return jspb.Message.setProto3StringIntField(this, 2, value);
};


/**
 * repeated ProviderModelParameter additionalParameters = 10;
 * @return {!Array<!proto.ProviderModelParameter>}
 */
proto.assistant_api.TextToSpeechConfig.prototype.getAdditionalparametersList = function() {
  return /** @type{!Array<!proto.ProviderModelParameter>} */ (
    jspb.Message.getRepeatedWrapperField(this, common_pb.ProviderModelParameter, 10));
};
 ...
 * @return {!proto.assistant_api.TextToSpeechConfig} returns this
*/
proto.assistant_api.TextToSpeechConfig.prototype.setAdditionalparametersList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 10, value);
};
 ...
 * @return {!proto.ProviderModelParameter}
 */
proto.assistant_api.TextToSpeechConfig.prototype.addAdditionalparameters = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 10, opt_value, proto.ProviderModelParameter, opt_index);
};
 ...
 * @return {!proto.assistant_api.TextToSpeechConfig} returns this
 */
proto.assistant_api.TextToSpeechConfig.prototype.clearAdditionalparametersList = function() {
  return this.setAdditionalparametersList([]);
};
 ...
 * @const
 */
proto.assistant_api.SpeechToTextConfig.repeatedFields_ = [10];
 ...
 * @return {!Object}
 */
proto.assistant_api.SpeechToTextConfig.prototype.toObject = function(opt_includeInstance) {
  return proto.assistant_api.SpeechToTextConfig.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.assistant_api.SpeechToTextConfig} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.assistant_api.SpeechToTextConfig.toObject = function(includeInstance, msg) {
  var f, obj = {
    providerid: jspb.Message.getFieldWithDefault(msg, 1, "0"),
    providermodelid: jspb.Message.getFieldWithDefault(msg, 2, "0"),
    additionalparametersList: jspb.Message.toObjectList(msg.getAdditionalparametersList(),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.assistant_api.SpeechToTextConfig}
 */
proto.assistant_api.SpeechToTextConfig.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.assistant_api.SpeechToTextConfig;
  return proto.assistant_api.SpeechToTextConfig.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.assistant_api.SpeechToTextConfig} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.assistant_api.SpeechToTextConfig}
 */
proto.assistant_api.SpeechToTextConfig.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.assistant_api.SpeechToTextConfig.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.assistant_api.SpeechToTextConfig.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.assistant_api.SpeechToTextConfig} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.assistant_api.SpeechToTextConfig.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getProviderid();
  if (parseInt(f, 10) !== 0) {
    writer.writeUint64String(
 ...
 * @return {string}
 */
proto.assistant_api.SpeechToTextConfig.prototype.getProviderid = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, "0"));
};
...
/**
 * @param {string} value
 * @return {!proto.assistant_api.SpeechToTextConfig} returns this
 */
proto.assistant_api.SpeechToTextConfig.prototype.setProviderid = function(value) {
  return jspb.Message.setProto3StringIntField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.assistant_api.SpeechToTextConfig.prototype.getProvidermodelid = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, "0"));
};
 ...
 * @return {!proto.assistant_api.SpeechToTextConfig} returns this
 */
proto.assistant_api.SpeechToTextConfig.prototype.setProvidermodelid = function(value) {
  return jspb.Message.setProto3StringIntField(this, 2, value);
};
 ...
 * @return {!Array<!proto.ProviderModelParameter>}
 */
proto.assistant_api.SpeechToTextConfig.prototype.getAdditionalparametersList = function() {
  return /** @type{!Array<!proto.ProviderModelParameter>} */ (
    jspb.Message.getRepeatedWrapperField(this, common_pb.ProviderModelParameter, 10));
};
 ...
 * @return {!proto.assistant_api.SpeechToTextConfig} returns this
*/
proto.assistant_api.SpeechToTextConfig.prototype.setAdditionalparametersList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 10, value);
};
 ...
 * @return {!proto.ProviderModelParameter}
 */
proto.assistant_api.SpeechToTextConfig.prototype.addAdditionalparameters = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 10, opt_value, proto.ProviderModelParameter, opt_index);
};
 ...
 * @return {!proto.assistant_api.SpeechToTextConfig} returns this
 */
proto.assistant_api.SpeechToTextConfig.prototype.clearAdditionalparametersList = function() {
  return this.setAdditionalparametersList([]);
};
 ...
 * @const
 */
proto.assistant_api.FileUploadConfig.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.assistant_api.FileUploadConfig.prototype.toObject = function(opt_includeInstance) {
  return proto.assistant_api.FileUploadConfig.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.assistant_api.FileUploadConfig} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.assistant_api.FileUploadConfig.toObject = function(includeInstance, msg) {
  var f, obj = {
    enabledfilesourceList: (f = jspb.Message.getRepeatedField(msg, 1)) == null ? undefined : f
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.assistant_api.FileUploadConfig}
 */
proto.assistant_api.FileUploadConfig.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.assistant_api.FileUploadConfig;
  return proto.assistant_api.FileUploadConfig.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.assistant_api.FileUploadConfig} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.assistant_api.FileUploadConfig}
 */
proto.assistant_api.FileUploadConfig.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 1:
      var value = /** @type {string} */ (reader.readString());
      msg.addEnabledfilesource(value);
      break;
    default:
      reader.skipField();
      break;
 ...
 * @return {!Uint8Array}
 */
proto.assistant_api.FileUploadConfig.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.assistant_api.FileUploadConfig.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.assistant_api.FileUploadConfig} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.assistant_api.FileUploadConfig.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getEnabledfilesourceList();
  if (f.length > 0) {
    writer.writeRepeatedString(
      1,
      f
...
/**
 * repeated string enabledFileSource = 1;
 * @return {!Array<string>}
 */
proto.assistant_api.FileUploadConfig.prototype.getEnabledfilesourceList = function() {
...
/**
 * @param {!Array<string>} value
 * @return {!proto.assistant_api.FileUploadConfig} returns this
 */
proto.assistant_api.FileUploadConfig.prototype.setEnabledfilesourceList = function(value) {
 ...
 * @return {!proto.assistant_api.FileUploadConfig} returns this
 */
proto.assistant_api.FileUploadConfig.prototype.addEnabledfilesource = function(value, opt_index) {
 ...
 * @return {!proto.assistant_api.FileUploadConfig} returns this
 */
proto.assistant_api.FileUploadConfig.prototype.clearEnabledfilesourceList = function() {
  return this.setEnabledfilesourceList([]);
};
 ...
 * @const
 */
proto.assistant_api.PersonalizeAssistantRequest.repeatedFields_ = [3];
 ...
 * @return {!Object}
 */
proto.assistant_api.PersonalizeAssistantRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.assistant_api.PersonalizeAssistantRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.assistant_api.PersonalizeAssistantRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.assistant_api.PersonalizeAssistantRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    assistantid: jspb.Message.getFieldWithDefault(msg, 1, "0"),
    deploymenttype: jspb.Message.getFieldWithDefault(msg, 8, ""),
    openingstatement: jspb.Message.getFieldWithDefault(msg, 2, ""),
    suggestedquestionsList: (f = jspb.Message.getRepeatedField(msg, 3)) == null ? undefined : f,
    assistanticonurl: jspb.Message.getFieldWithDefault(msg, 4, ""),
    texttospeechconfig: (f = msg.getTexttospeechconfig()) && proto.assistant_api.TextToSpeechConfig.toObject(includeInstance, f),
    speechtotextconfig: (f = msg.getSpeechtotextconfig()) && proto.assistant_api.SpeechToTextConfig.toObject(includeInstance, f),
    fileuploadconfig: (f = msg.getFileuploadconfig()) && proto.assistant_api.FileUploadConfig.toObject(includeInstance, f),
    assistanticon: (f = msg.getAssistanticon()) && common_pb.Content.toObject(includeInstance, f),
    assistantname: jspb.Message.getFieldWithDefault(msg, 10, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.assistant_api.PersonalizeAssistantRequest}
 */
proto.assistant_api.PersonalizeAssistantRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.assistant_api.PersonalizeAssistantRequest;
  return proto.assistant_api.PersonalizeAssistantRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.assistant_api.PersonalizeAssistantRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.assistant_api.PersonalizeAssistantRequest}
 */
proto.assistant_api.PersonalizeAssistantRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 4:
      var value = /** @type {string} */ (reader.readString());
      msg.setAssistanticonurl(value);
      break;
    case 5:
      var value = new proto.assistant_api.TextToSpeechConfig;
      reader.readMessage(value,proto.assistant_api.TextToSpeechConfig.deserializeBinaryFromReader);
      msg.setTexttospeechconfig(value);
      break;
    case 6:
      var value = new proto.assistant_api.SpeechToTextConfig;
      reader.readMessage(value,proto.assistant_api.SpeechToTextConfig.deserializeBinaryFromReader);
      msg.setSpeechtotextconfig(value);
      break;
    case 7:
      var value = new proto.assistant_api.FileUploadConfig;
      reader.readMessage(value,proto.assistant_api.FileUploadConfig.deserializeBinaryFromReader);
      msg.setFileuploadconfig(value);
      break;
    case 9:
      var value = new common_pb.Content;
      reader.readMessage(value,common_pb.Content.deserializeBinaryFromReader);
      msg.setAssistanticon(value);
      break;
    case 10:
      var value = /** @type {string} */ (reader.readString());
      msg.setAssistantname(value);
      break;
    default:
      reader.skipField();
      break;
 ...
 * @return {!Uint8Array}
 */
proto.assistant_api.PersonalizeAssistantRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.assistant_api.PersonalizeAssistantRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.assistant_api.PersonalizeAssistantRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.assistant_api.PersonalizeAssistantRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getAssistantid();
  if (parseInt(f, 10) !== 0) {
    writer.writeUint64String(
  ...
  f = message.getTexttospeechconfig();
  if (f != null) {
    writer.writeMessage(
      5,
      f,
      proto.assistant_api.TextToSpeechConfig.serializeBinaryToWriter
    );
  }
  f = message.getSpeechtotextconfig();
  if (f != null) {
    writer.writeMessage(
      6,
      f,
      proto.assistant_api.SpeechToTextConfig.serializeBinaryToWriter
    );
  }
  f = message.getFileuploadconfig();
  if (f != null) {
    writer.writeMessage(
      7,
      f,
      proto.assistant_api.FileUploadConfig.serializeBinaryToWriter
    );
  }
  f = message.getAssistanticon();
  if (f != null) {
    writer.writeMessage(
      9,
      f,
 ...
 * @return {string}
 */
proto.assistant_api.PersonalizeAssistantRequest.prototype.getAssistantid = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, "0"));
};
...
/**
 * @param {string} value
 * @return {!proto.assistant_api.PersonalizeAssistantRequest} returns this
 */
proto.assistant_api.PersonalizeAssistantRequest.prototype.setAssistantid = function(value) {
  return jspb.Message.setProto3StringIntField(this, 1, value);
};


/**
 * optional string deploymentType = 8;
 * @return {string}
 */
proto.assistant_api.PersonalizeAssistantRequest.prototype.getDeploymenttype = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 8, ""));
};
 ...
 * @return {!proto.assistant_api.PersonalizeAssistantRequest} returns this
 */
proto.assistant_api.PersonalizeAssistantRequest.prototype.setDeploymenttype = function(value) {
  return jspb.Message.setProto3StringField(this, 8, value);
};


/**
 * optional string openingStatement = 2;
 * @return {string}
 */
proto.assistant_api.PersonalizeAssistantRequest.prototype.getOpeningstatement = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.assistant_api.PersonalizeAssistantRequest} returns this
 */
proto.assistant_api.PersonalizeAssistantRequest.prototype.setOpeningstatement = function(value) {
  return jspb.Message.setField(this, 2, value);
};
 ...
 * @return {!proto.assistant_api.PersonalizeAssistantRequest} returns this
 */
proto.assistant_api.PersonalizeAssistantRequest.prototype.clearOpeningstatement = function() {
 ...
 * @return {boolean}
 */
proto.assistant_api.PersonalizeAssistantRequest.prototype.hasOpeningstatement = function() {
  return jspb.Message.getField(this, 2) != null;
};
 ...
 * @return {!Array<string>}
 */
proto.assistant_api.PersonalizeAssistantRequest.prototype.getSuggestedquestionsList = function() {
 ...
 * @return {!proto.assistant_api.PersonalizeAssistantRequest} returns this
 */
proto.assistant_api.PersonalizeAssistantRequest.prototype.setSuggestedquestionsList = function(value) {
 ...
 * @return {!proto.assistant_api.PersonalizeAssistantRequest} returns this
 */
proto.assistant_api.PersonalizeAssistantRequest.prototype.addSuggestedquestions = function(value, opt_index) {
 ...
 * @return {!proto.assistant_api.PersonalizeAssistantRequest} returns this
 */
proto.assistant_api.PersonalizeAssistantRequest.prototype.clearSuggestedquestionsList = function() {
  return this.setSuggestedquestionsList([]);
};


/**
 * optional string assistantIconUrl = 4;
 * @return {string}
 */
proto.assistant_api.PersonalizeAssistantRequest.prototype.getAssistanticonurl = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};
 ...
 * @return {!proto.assistant_api.PersonalizeAssistantRequest} returns this
 */
proto.assistant_api.PersonalizeAssistantRequest.prototype.setAssistanticonurl = function(value) {
  return jspb.Message.setField(this, 4, value);
};
 ...
 * @return {!proto.assistant_api.PersonalizeAssistantRequest} returns this
 */
proto.assistant_api.PersonalizeAssistantRequest.prototype.clearAssistanticonurl = function() {
  return jspb.Message.setField(this, 4, undefined);
};
 ...
 * @return {boolean}
 */
proto.assistant_api.PersonalizeAssistantRequest.prototype.hasAssistanticonurl = function() {
  return jspb.Message.getField(this, 4) != null;
};


/**
 * optional TextToSpeechConfig textToSpeechConfig = 5;
 * @return {?proto.assistant_api.TextToSpeechConfig}
 */
proto.assistant_api.PersonalizeAssistantRequest.prototype.getTexttospeechconfig = function() {
  return /** @type{?proto.assistant_api.TextToSpeechConfig} */ (
    jspb.Message.getWrapperField(this, proto.assistant_api.TextToSpeechConfig, 5));
};


/**
 * @param {?proto.assistant_api.TextToSpeechConfig|undefined} value
 * @return {!proto.assistant_api.PersonalizeAssistantRequest} returns this
*/
proto.assistant_api.PersonalizeAssistantRequest.prototype.setTexttospeechconfig = function(value) {
  return jspb.Message.setWrapperField(this, 5, value);
};
 ...
 * @return {!proto.assistant_api.PersonalizeAssistantRequest} returns this
 */
proto.assistant_api.PersonalizeAssistantRequest.prototype.clearTexttospeechconfig = function() {
  return this.setTexttospeechconfig(undefined);
};
 ...
 * @return {boolean}
 */
proto.assistant_api.PersonalizeAssistantRequest.prototype.hasTexttospeechconfig = function() {
  return jspb.Message.getField(this, 5) != null;
};


/**
 * optional SpeechToTextConfig speechToTextConfig = 6;
 * @return {?proto.assistant_api.SpeechToTextConfig}
 */
proto.assistant_api.PersonalizeAssistantRequest.prototype.getSpeechtotextconfig = function() {
  return /** @type{?proto.assistant_api.SpeechToTextConfig} */ (
    jspb.Message.getWrapperField(this, proto.assistant_api.SpeechToTextConfig, 6));
};


/**
 * @param {?proto.assistant_api.SpeechToTextConfig|undefined} value
 * @return {!proto.assistant_api.PersonalizeAssistantRequest} returns this
*/
proto.assistant_api.PersonalizeAssistantRequest.prototype.setSpeechtotextconfig = function(value) {
  return jspb.Message.setWrapperField(this, 6, value);
};
 ...
 * @return {!proto.assistant_api.PersonalizeAssistantRequest} returns this
 */
proto.assistant_api.PersonalizeAssistantRequest.prototype.clearSpeechtotextconfig = function() {
  return this.setSpeechtotextconfig(undefined);
};
 ...
 * @return {boolean}
 */
proto.assistant_api.PersonalizeAssistantRequest.prototype.hasSpeechtotextconfig = function() {
  return jspb.Message.getField(this, 6) != null;
};


/**
 * optional FileUploadConfig fileUploadConfig = 7;
 * @return {?proto.assistant_api.FileUploadConfig}
 */
proto.assistant_api.PersonalizeAssistantRequest.prototype.getFileuploadconfig = function() {
  return /** @type{?proto.assistant_api.FileUploadConfig} */ (
    jspb.Message.getWrapperField(this, proto.assistant_api.FileUploadConfig, 7));
};


/**
 * @param {?proto.assistant_api.FileUploadConfig|undefined} value
 * @return {!proto.assistant_api.PersonalizeAssistantRequest} returns this
*/
proto.assistant_api.PersonalizeAssistantRequest.prototype.setFileuploadconfig = function(value) {
  return jspb.Message.setWrapperField(this, 7, value);
};
 ...
 * @return {!proto.assistant_api.PersonalizeAssistantRequest} returns this
 */
proto.assistant_api.PersonalizeAssistantRequest.prototype.clearFileuploadconfig = function() {
  return this.setFileuploadconfig(undefined);
};
 ...
 * @return {boolean}
 */
proto.assistant_api.PersonalizeAssistantRequest.prototype.hasFileuploadconfig = function() {
  return jspb.Message.getField(this, 7) != null;
};


/**
 * optional Content assistantIcon = 9;
 * @return {?proto.Content}
 */
proto.assistant_api.PersonalizeAssistantRequest.prototype.getAssistanticon = function() {
  return /** @type{?proto.Content} */ (
    jspb.Message.getWrapperField(this, common_pb.Content, 9));
};
 ...
 * @return {!proto.assistant_api.PersonalizeAssistantRequest} returns this
*/
proto.assistant_api.PersonalizeAssistantRequest.prototype.setAssistanticon = function(value) {
  return jspb.Message.setWrapperField(this, 9, value);
};
 ...
 * @return {!proto.assistant_api.PersonalizeAssistantRequest} returns this
 */
proto.assistant_api.PersonalizeAssistantRequest.prototype.clearAssistanticon = function() {
  return this.setAssistanticon(undefined);
};
 ...
 * @return {boolean}
 */
proto.assistant_api.PersonalizeAssistantRequest.prototype.hasAssistanticon = function() {
  return jspb.Message.getField(this, 9) != null;
};


/**
 * optional string assistantName = 10;
 * @return {string}
 */
proto.assistant_api.PersonalizeAssistantRequest.prototype.getAssistantname = function() {
 ...
 * @return {!proto.assistant_api.PersonalizeAssistantRequest} returns this
 */
proto.assistant_api.PersonalizeAssistantRequest.prototype.setAssistantname = function(value) {
 ...
 * @return {!proto.assistant_api.PersonalizeAssistantRequest} returns this
 */
proto.assistant_api.PersonalizeAssistantRequest.prototype.clearAssistantname = function() {
 ...
 * @return {boolean}
 */
proto.assistant_api.PersonalizeAssistantRequest.prototype.hasAssistantname = function() {
  return jspb.Message.getField(this, 10) != null;
};
 ...
 * @const
 */
proto.assistant_api.GetAllAssistantSessionRequest.repeatedFields_ = [3];
 ...
 * @return {!Object}
 */
proto.assistant_api.GetAllAssistantSessionRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.assistant_api.GetAllAssistantSessionRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.assistant_api.GetAllAssistantSessionRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.assistant_api.GetAllAssistantSessionRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    assistantid: jspb.Message.getFieldWithDefault(msg, 1, "0"),
    paginate: (f = msg.getPaginate()) && common_pb.Paginate.toObject(includeInstance, f),
    criteriasList: jspb.Message.toObjectList(msg.getCriteriasList(),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.assistant_api.GetAllAssistantSessionRequest}
 */
proto.assistant_api.GetAllAssistantSessionRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.assistant_api.GetAllAssistantSessionRequest;
  return proto.assistant_api.GetAllAssistantSessionRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.assistant_api.GetAllAssistantSessionRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.assistant_api.GetAllAssistantSessionRequest}
 */
proto.assistant_api.GetAllAssistantSessionRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.assistant_api.GetAllAssistantSessionRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.assistant_api.GetAllAssistantSessionRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.assistant_api.GetAllAssistantSessionRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.assistant_api.GetAllAssistantSessionRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getAssistantid();
  if (parseInt(f, 10) !== 0) {
    writer.writeUint64String(
 ...
 * @return {string}
 */
proto.assistant_api.GetAllAssistantSessionRequest.prototype.getAssistantid = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, "0"));
};
...
/**
 * @param {string} value
 * @return {!proto.assistant_api.GetAllAssistantSessionRequest} returns this
 */
proto.assistant_api.GetAllAssistantSessionRequest.prototype.setAssistantid = function(value) {
  return jspb.Message.setProto3StringIntField(this, 1, value);
};
 ...
 * @return {?proto.Paginate}
 */
proto.assistant_api.GetAllAssistantSessionRequest.prototype.getPaginate = function() {
  return /** @type{?proto.Paginate} */ (
 ...
 * @return {!proto.assistant_api.GetAllAssistantSessionRequest} returns this
*/
proto.assistant_api.GetAllAssistantSessionRequest.prototype.setPaginate = function(value) {
  return jspb.Message.setWrapperField(this, 2, value);
};
 ...
 * @return {!proto.assistant_api.GetAllAssistantSessionRequest} returns this
 */
proto.assistant_api.GetAllAssistantSessionRequest.prototype.clearPaginate = function() {
  return this.setPaginate(undefined);
};
 ...
 * @return {boolean}
 */
proto.assistant_api.GetAllAssistantSessionRequest.prototype.hasPaginate = function() {
  return jspb.Message.getField(this, 2) != null;
};
 ...
 * @return {!Array<!proto.Criteria>}
 */
proto.assistant_api.GetAllAssistantSessionRequest.prototype.getCriteriasList = function() {
  return /** @type{!Array<!proto.Criteria>} */ (
 ...
 * @return {!proto.assistant_api.GetAllAssistantSessionRequest} returns this
*/
proto.assistant_api.GetAllAssistantSessionRequest.prototype.setCriteriasList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 3, value);
};
 ...
 * @return {!proto.Criteria}
 */
proto.assistant_api.GetAllAssistantSessionRequest.prototype.addCriterias = function(opt_value, opt_index) {
 ...
 * @return {!proto.assistant_api.GetAllAssistantSessionRequest} returns this
 */
proto.assistant_api.GetAllAssistantSessionRequest.prototype.clearCriteriasList = function() {
  return this.setCriteriasList([]);
};
 ...
 * @return {!proto.Source}
 */
proto.assistant_api.GetAllAssistantSessionRequest.prototype.getSource = function() {
 ...
 * @return {!proto.assistant_api.GetAllAssistantSessionRequest} returns this
 */
proto.assistant_api.GetAllAssistantSessionRequest.prototype.setSource = function(value) {
 ...
 * @const
 */
proto.assistant_api.GetAllAssistantSessionResponse.repeatedFields_ = [3];
 ...
 * @return {!Object}
 */
proto.assistant_api.GetAllAssistantSessionResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.assistant_api.GetAllAssistantSessionResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.assistant_api.GetAllAssistantSessionResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.assistant_api.GetAllAssistantSessionResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    code: jspb.Message.getFieldWithDefault(msg, 1, 0),
    success: jspb.Message.getBooleanFieldWithDefault(msg, 2, false),
    dataList: jspb.Message.toObjectList(msg.getDataList(),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.assistant_api.GetAllAssistantSessionResponse}
 */
proto.assistant_api.GetAllAssistantSessionResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.assistant_api.GetAllAssistantSessionResponse;
  return proto.assistant_api.GetAllAssistantSessionResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.assistant_api.GetAllAssistantSessionResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.assistant_api.GetAllAssistantSessionResponse}
 */
proto.assistant_api.GetAllAssistantSessionResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.assistant_api.GetAllAssistantSessionResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.assistant_api.GetAllAssistantSessionResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.assistant_api.GetAllAssistantSessionResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.assistant_api.GetAllAssistantSessionResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getCode();
  if (f !== 0) {
    writer.writeInt32(
 ...
 * @return {number}
 */
proto.assistant_api.GetAllAssistantSessionResponse.prototype.getCode = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.assistant_api.GetAllAssistantSessionResponse} returns this
 */
proto.assistant_api.GetAllAssistantSessionResponse.prototype.setCode = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {boolean}
 */
proto.assistant_api.GetAllAssistantSessionResponse.prototype.getSuccess = function() {
  return /** @type {boolean} */ (jspb.Message.getBooleanFieldWithDefault(this, 2, false));
};
 ...
 * @return {!proto.assistant_api.GetAllAssistantSessionResponse} returns this
 */
proto.assistant_api.GetAllAssistantSessionResponse.prototype.setSuccess = function(value) {
  return jspb.Message.setProto3BooleanField(this, 2, value);
};
 ...
 */
proto.assistant_api.GetAllAssistantSessionResponse.prototype.getDataList = function() {
 ...
 * @return {!proto.assistant_api.GetAllAssistantSessionResponse} returns this
*/
proto.assistant_api.GetAllAssistantSessionResponse.prototype.setDataList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 3, value);
};
 ...
 */
proto.assistant_api.GetAllAssistantSessionResponse.prototype.addData = function(opt_value, opt_index) {
 ...
 * @return {!proto.assistant_api.GetAllAssistantSessionResponse} returns this
 */
proto.assistant_api.GetAllAssistantSessionResponse.prototype.clearDataList = function() {
  return this.setDataList([]);
};
 ...
 * @return {?proto.Error}
 */
proto.assistant_api.GetAllAssistantSessionResponse.prototype.getError = function() {
  return /** @type{?proto.Error} */ (
    jspb.Message.getWrapperField(this, common_pb.Error, 4));
};
 ...
 * @return {!proto.assistant_api.GetAllAssistantSessionResponse} returns this
*/
proto.assistant_api.GetAllAssistantSessionResponse.prototype.setError = function(value) {
  return jspb.Message.setWrapperField(this, 4, value);
};
 ...
 * @return {!proto.assistant_api.GetAllAssistantSessionResponse} returns this
 */
proto.assistant_api.GetAllAssistantSessionResponse.prototype.clearError = function() {
  return this.setError(undefined);
};
 ...
 * @return {boolean}
 */
proto.assistant_api.GetAllAssistantSessionResponse.prototype.hasError = function() {
  return jspb.Message.getField(this, 4) != null;
};
 ...
 * @return {?proto.Paginated}
 */
proto.assistant_api.GetAllAssistantSessionResponse.prototype.getPaginated = function() {
  return /** @type{?proto.Paginated} */ (
    jspb.Message.getWrapperField(this, common_pb.Paginated, 5));
};
 ...
 * @return {!proto.assistant_api.GetAllAssistantSessionResponse} returns this
*/
proto.assistant_api.GetAllAssistantSessionResponse.prototype.setPaginated = function(value) {
  return jspb.Message.setWrapperField(this, 5, value);
};
 ...
 * @return {!proto.assistant_api.GetAllAssistantSessionResponse} returns this
 */
proto.assistant_api.GetAllAssistantSessionResponse.prototype.clearPaginated = function() {
  return this.setPaginated(undefined);
};
 ...
 * @return {boolean}
 */
proto.assistant_api.GetAllAssistantSessionResponse.prototype.hasPaginated = function() {
  return jspb.Message.getField(this, 5) != null;
};
