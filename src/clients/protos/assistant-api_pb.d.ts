...
export class TextToSpeechConfig extends jspb.Message {
  getProviderid(): string;
  setProviderid(value: string): void;
  ...
  clearAdditionalparametersList(): void;
  getAdditionalparametersList(): Array<common_pb.ProviderModelParameter>;
  setAdditionalparametersList(value: Array<common_pb.ProviderModelParameter>): void;
  addAdditionalparameters(value?: common_pb.ProviderModelParameter, index?: number): common_pb.ProviderModelParameter;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): TextToSpeechConfig.AsObject;
  static toObject(includeInstance: boolean, msg: TextToSpeechConfig): TextToSpeechConfig.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: TextToSpeechConfig, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): TextToSpeechConfig;
  static deserializeBinaryFromReader(message: TextToSpeechConfig, reader: jspb.BinaryReader): TextToSpeechConfig;
}

export namespace TextToSpeechConfig {
  export type AsObject = {
    providerid: string,
    providermodelid: string,
    additionalparametersList: Array<common_pb.ProviderModelParameter.AsObject>,
  }
}

export class SpeechToTextConfig extends jspb.Message {
  getProviderid(): string;
  setProviderid(value: string): void;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): SpeechToTextConfig.AsObject;
  static toObject(includeInstance: boolean, msg: SpeechToTextConfig): SpeechToTextConfig.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: SpeechToTextConfig, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): SpeechToTextConfig;
  static deserializeBinaryFromReader(message: SpeechToTextConfig, reader: jspb.BinaryReader): SpeechToTextConfig;
}

export namespace SpeechToTextConfig {
  export type AsObject = {
    providerid: string,
    providermodelid: string,
    additionalparametersList: Array<common_pb.ProviderModelParameter.AsObject>,
...
export class FileUploadConfig extends jspb.Message {
  clearEnabledfilesourceList(): void;
  getEnabledfilesourceList(): Array<string>;
  setEnabledfilesourceList(value: Array<string>): void;
  addEnabledfilesource(value: string, index?: number): string;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): FileUploadConfig.AsObject;
  static toObject(includeInstance: boolean, msg: FileUploadConfig): FileUploadConfig.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: FileUploadConfig, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): FileUploadConfig;
  static deserializeBinaryFromReader(message: FileUploadConfig, reader: jspb.BinaryReader): FileUploadConfig;
}

export namespace FileUploadConfig {
  export type AsObject = {
    enabledfilesourceList: Array<string>,
  }
}

export class PersonalizeAssistantRequest extends jspb.Message {
  getAssistantid(): string;
  setAssistantid(value: string): void;
  ...
  hasOpeningstatement(): boolean;
  clearOpeningstatement(): void;
  getOpeningstatement(): string;
  setOpeningstatement(value: string): void;
  ...
  hasAssistanticonurl(): boolean;
  clearAssistanticonurl(): void;
  getAssistanticonurl(): string;
  setAssistanticonurl(value: string): void;

  hasTexttospeechconfig(): boolean;
  clearTexttospeechconfig(): void;
  getTexttospeechconfig(): TextToSpeechConfig | undefined;
  setTexttospeechconfig(value?: TextToSpeechConfig): void;

  hasSpeechtotextconfig(): boolean;
  clearSpeechtotextconfig(): void;
  getSpeechtotextconfig(): SpeechToTextConfig | undefined;
  setSpeechtotextconfig(value?: SpeechToTextConfig): void;

  hasFileuploadconfig(): boolean;
  clearFileuploadconfig(): void;
  getFileuploadconfig(): FileUploadConfig | undefined;
  setFileuploadconfig(value?: FileUploadConfig): void;

  hasAssistanticon(): boolean;
  clearAssistanticon(): void;
  getAssistanticon(): common_pb.Content | undefined;
  setAssistanticon(value?: common_pb.Content): void;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): PersonalizeAssistantRequest.AsObject;
  static toObject(includeInstance: boolean, msg: PersonalizeAssistantRequest): PersonalizeAssistantRequest.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: PersonalizeAssistantRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): PersonalizeAssistantRequest;
  static deserializeBinaryFromReader(message: PersonalizeAssistantRequest, reader: jspb.BinaryReader): PersonalizeAssistantRequest;
}

export namespace PersonalizeAssistantRequest {
  export type AsObject = {
    assistantid: string,
    ...
    texttospeechconfig?: TextToSpeechConfig.AsObject,
    speechtotextconfig?: SpeechToTextConfig.AsObject,
    fileuploadconfig?: FileUploadConfig.AsObject,
    assistanticon?: common_pb.Content.AsObject,
    assistantname: string,
  }
}

export class GetAllAssistantSessionRequest extends jspb.Message {
  getAssistantid(): string;
  setAssistantid(value: string): void;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): GetAllAssistantSessionRequest.AsObject;
  static toObject(includeInstance: boolean, msg: GetAllAssistantSessionRequest): GetAllAssistantSessionRequest.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: GetAllAssistantSessionRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): GetAllAssistantSessionRequest;
  static deserializeBinaryFromReader(message: GetAllAssistantSessionRequest, reader: jspb.BinaryReader): GetAllAssistantSessionRequest;
}

export namespace GetAllAssistantSessionRequest {
  export type AsObject = {
    assistantid: string,
    paginate?: common_pb.Paginate.AsObject,
    criteriasList: Array<common_pb.Criteria.AsObject>,
...
export class GetAllAssistantSessionResponse extends jspb.Message {
  getCode(): number;
  setCode(value: number): void;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): GetAllAssistantSessionResponse.AsObject;
  static toObject(includeInstance: boolean, msg: GetAllAssistantSessionResponse): GetAllAssistantSessionResponse.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: GetAllAssistantSessionResponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): GetAllAssistantSessionResponse;
  static deserializeBinaryFromReader(message: GetAllAssistantSessionResponse, reader: jspb.BinaryReader): GetAllAssistantSessionResponse;
}

export namespace GetAllAssistantSessionResponse {
  export type AsObject = {
    code: number,
    success: boolean,
