...
type AssistantServicePersonalizeAssistant = {
  readonly methodName: string;
  readonly service: typeof AssistantService;
  readonly requestStream: false;
  readonly responseStream: false;
  readonly requestType: typeof assistant_api_pb.PersonalizeAssistantRequest;
  readonly responseType: typeof assistant_api_pb.GetAssistantResponse;
};
...
type AssistantServiceGetAllAssistantSession = {
  readonly methodName: string;
  readonly service: typeof AssistantService;
  readonly requestStream: false;
  readonly responseStream: false;
  readonly requestType: typeof assistant_api_pb.GetAllAssistantSessionRequest;
  readonly responseType: typeof assistant_api_pb.GetAllAssistantSessionResponse;
};
...
export class AssistantService {
  ...
  static readonly PersonalizeAssistant: AssistantServicePersonalizeAssistant;
  static readonly GetAllAssistantMessage: AssistantServiceGetAllAssistantMessage;
  static readonly GetAllAssistantSession: AssistantServiceGetAllAssistantSession;
...
export class AssistantServiceClient {
  ...
  personalizeAssistant(
    requestMessage: assistant_api_pb.PersonalizeAssistantRequest,
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: assistant_api_pb.GetAssistantResponse|null) => void
  ): UnaryResponse;
  personalizeAssistant(
  ...
  getAllAssistantSession(
    requestMessage: assistant_api_pb.GetAllAssistantSessionRequest,
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: assistant_api_pb.GetAllAssistantSessionResponse|null) => void
  ): UnaryResponse;
  getAllAssistantSession(
    requestMessage: assistant_api_pb.GetAllAssistantSessionRequest,
    callback: (error: ServiceError|null, responseMessage: assistant_api_pb.GetAllAssistantSessionResponse|null) => void
