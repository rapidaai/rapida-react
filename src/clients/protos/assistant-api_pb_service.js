...
AssistantService.PersonalizeAssistant = {
  methodName: "PersonalizeAssistant",
  service: AssistantService,
  requestStream: false,
  responseStream: false,
  requestType: assistant_api_pb.PersonalizeAssistantRequest,
  responseType: assistant_api_pb.GetAssistantResponse
};
...
AssistantService.GetAllAssistantSession = {
  methodName: "GetAllAssistantSession",
  service: AssistantService,
  requestStream: false,
  responseStream: false,
  requestType: assistant_api_pb.GetAllAssistantSessionRequest,
  responseType: assistant_api_pb.GetAllAssistantSessionResponse
};
...
AssistantServiceClient.prototype.personalizeAssistant = function personalizeAssistant(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(AssistantService.PersonalizeAssistant, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
...
AssistantServiceClient.prototype.getAllAssistantSession = function getAllAssistantSession(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(AssistantService.GetAllAssistantSession, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
